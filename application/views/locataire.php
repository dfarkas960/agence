          ...
          <div id="main">
						...
						<!-- Post -->
							<article class="post">
								<header>
									<div class="title">
										<h2><a href="#">Administration CRUD locataires</a></h2>
										<p>Gérer les locataires </p>
									</div>
                </header>
									<form method="post" action="registerLocats">
                      ...
                      <div class="col-6 col-12-xsmall">
                        <label for="loyer_paye">Dernier loyer payé</label>
												<input type="date" name="loyer_paye" id="loyer_paye" placeholder="dernier loyer payé" />
                      </div>
                      <div class="col-6 col-12-xsmall">
                        <label for="date_in">Date d'entrée</label>
												<input type="date" name="date_in" id="date_in" placeholder="date d'entrée" />
                      </div><div class="col-6 col-12-xsmall">
                        <label for="date_out">Date de sortie</label>
												<input type="date" name="date_out" id="date_out" placeholder="date de sortie" />
                      </div>
