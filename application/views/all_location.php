          ...
          <div id="main">
						...
						<!-- Post -->
							<article class="post">
								<header>
									<div class="title">
										<h2><a href="#">Nos derniers biens en location</a></h2>
                ...
                { ?>
								  ...
								  <div class="mini-posts">
									...
									<input type="hidden" name="loyer" id="loyer" value="<?= $row->loyer ?>" />
									<input type="hidden" name="charges" id="charges" value="<?= $row->charges ?>" />
