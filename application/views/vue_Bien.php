 ...
 <html>
 		...
 		<!-- Wrapper -->
 			<div id="wrapper">
 				...
 				<!-- Main -->
                    ...
                    <h3>propriétaire <?= $row->nom ?> , ID: <?= $row->id_proprio ?></h3>
                    <h3>email: <?= $row->email ?></h3>
 										<h2>liste de ses biens et Caractéristiques</a></h2>
                   ...
                   <div class="table-wrapper">
                     <table class="floatLeft third alt">
                       <thead>
                         ...
                         <tr>
                           <td>Ancien</td>
                           <td><?php if ($row->ancien=0){echo "Nouveau";} else {echo "Oui";} ?></td>
                         </tr>
                         <tr>
                           <td>Etage</td>
                           <td><?= $row->etage ?></td>
  ...
  <?php } ?>
 								...
 								<footer>
 									...
 									<ul class="actions">
 										<li></li>
 										<li><a href="<?=base_url('cruds/index')?>" class="button large">CRUD</a></li>
 									</ul>
                ...
                { ?>
                      ...
                      <h2 style="color:#F5C823"><?= $row->ville ?></h2>
                      <h3>Montant du loyer:</h3>
                       <?= '<h2 style="color:#F5C823">'.$row->loyer."</h2>" ?>
                       <h3>Euros + Charges</h3>
